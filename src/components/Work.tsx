    ...
    <section id="work" className="work-section section-space" aria-labelledby="work-title">
      <div className="page-width">
        <Reveal className="work-intro">
          ...
          <p>Разработка вашего проекта — от идеи и интерфейса до готовой публикации. Создаю проекты с нуля, реализую адаптивную вёрстку и дорабатываю существующие продукты.</p>
        </Reveal>
